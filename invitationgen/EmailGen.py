...
def generate_email_content(meta: MetaBundle):
    ...
    generic_email_html_button.replace("MAIN_COLOUR_SERVER_LOCATION", build_main_instruction_location(meta.get_group()))
    generic_email_html_button.replace("MIRROR_COLOUR_SERVER_LOCATION",
                                      build_mirror_instruction_location(meta.get_group()))
